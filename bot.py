...
#     user_id = message.message.from_user.id
#     await message.message.delete()
#     add_namunali(message.from_user.id, "Mentor o'z vaqtida ish joyida")
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_pie_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Olloyorov Sirojiddin umumiy analitikasi', reply_markup=nav.viewcoment2)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Olloyorov Sirojiddin qoyilgan kamentariyalar', reply_markup=nav.adm_menu)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_pie_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Rasulov Rahmatulloh umumiy analitikasi', reply_markup=nav.viewcoment3)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Rasulov Rahmatulloh qoyilgan kamentariyalar', reply_markup=nav.adm_menu)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_pie_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Shomurodov Sarvarbek umumiy analitikasi', reply_markup=nav.viewcoment4)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Shomurodov Sarvarbek qoyilgan kamentariyalar', reply_markup=nav.adm_menu)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Arslanova Nodira qoyilgan kamentariyalar', reply_markup=nav.adm_menu)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_pie_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Alimbayeva Asalbonu umumiy analitikasi', reply_markup=nav.viewcoment8)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Alimbayeva Asalbonu qoyilgan kamentariyalar', reply_markup=nav.adm_menu)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_pie_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Orifjonov Abdulaziz umumiy analitikasi', reply_markup=nav.viewcoment9)
...
async def admin_nodira(message: types.CallbackQuery):
    ...
    img = open('image/mentor_barh_plot.png', 'rb')
    await bot.send_photo(message.from_user.id, img, 'Orifjonov Abdulaziz qoyilgan kamentariyalar', reply_markup=nav.adm_menu)

#
# class FSMAdmin(StatesGroup):
#     mentor_ismi = State()
#
#     @dp.callback_query_handler(text='ds_panel')
#     async def admPanel_ds(message: types.CallbackQuery):
#         await bot.send_message(message.from_user.id, 'DS TEST', reply_markup=types.ReplyKeyboardRemove())
...
#
#
#     @dp.callback_query_handler(text='fs_panel')
#     async def admPanel_fs(message: types.CallbackQuery):
#         await bot.send_message(message.from_user.id, 'FS TEST', reply_markup=types.ReplyKeyboardRemove())
#         await FSMAdmin.mentor_ismi.set()
#         await message.reply("Mentor ismini kiriting !")
#
#
#     @dp.callback_query_handler(text='se_panel')
#     async def admPanel_se(message: types.CallbackQuery):
#         await bot.send_message(message.from_user.id, 'SE TEST', reply_markup=types.ReplyKeyboardRemove())
#         await FSMAdmin.mentor_ismi.set()
#         await message.reply("Mentor ismini kiriting !")

    # @dp.message_handler(state=FSMAdmin.mentor_ismi)
...
async def other_message(message: types.Message):
    if message.chat.type == 'private':
        ...
        if message.text == 'asd':
            await bot.send_message(message.from_user.id, 'Welcome to admin system :)') #, reply_markup=nav.btn_admPanel)
